...
function SectionImage({
  ...
  return (
    <div className="relative rounded-3xl overflow-hidden min-h-[280px] border border-[#D5E0DC] shadow-sm bg-white">
      <img
        src={src}
        alt={alt}
        loading="lazy"
        ...
        <div className="container-padded">
          <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            <div className="md:sticky md:top-24 order-1 md:order-2">
              <div className="aspect-square bg-white rounded-3xl shadow-md border border-[#D5E0DC]/50 relative overflow-hidden">
                <img
                  src={pdpImages.hero}
                  alt={product.nameAr}
                  fetchPriority="high"
                ...
                {/* Social proof overlay — bottom */}
                <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm p-3 flex items-center gap-3 border-t border-[#D5E0DC]">
                  ...
                  <div className="min-w-0">
                    <p className="font-bold text-xs text-[#1A2332]">٤.٩/٥ · ١٢٠+ تقييم موثّق</p>
                    <p className="text-[10px] text-[#5A6A72]">من عميلات في السعودية</p>
                  </div>
                  <span className="mr-auto shrink-0 text-[10px] font-bold text-[#2D8B6F] bg-[#2D8B6F]/10 px-2 py-0.5 rounded-full whitespace-nowrap">
